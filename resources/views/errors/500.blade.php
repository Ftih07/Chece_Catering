...
<head>
    ...
    <title>500 - Kesalahan Server Internal | Cheche Catering</title>
...
<body>
    ...
    <!-- 500 Error Page -->
    <div id="error-500" class="error-container error-500 hidden">
        <div class="error-bg">
            <div
                class="floating-food"
                style="top: 12%; left: 8%; font-size: 3rem">
                ⚙️
            </div>
            <div
                class="floating-food"
                style="top: 22%; right: 12%; font-size: 2.5rem">
                🔧
            </div>
            <div
                class="floating-food"
                style="bottom: 28%; left: 18%; font-size: 2rem">
                🛠️
            </div>
            <div
                class="floating-food"
                style="bottom: 18%; right: 22%; font-size: 3.5rem">
                ⚡
            </div>
            <div
                class="floating-food"
                style="top: 48%; left: 6%; font-size: 2.2rem">
                🔥
            </div>
            <div
                class="floating-food"
                style="top: 68%; right: 8%; font-size: 2.8rem">
                💥
            </div>
        </div>
        ...
        <div class="error-card">
            ...
            <h1 class="error-title">Server <span>Bermasalah</span></h1>
            <p class="error-description">
                Ups! Sepertinya ada masalah di dapur kami. Tim teknis sedang
                bekerja keras memperbaiki sistem. Silakan coba lagi
                sebentar.
            </p>
        </div>
    </div>
