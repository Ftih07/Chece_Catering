...
<head>
    ...
    <title>403 - Akses Terlarang | Cheche Catering</title>
...
<body>
    ...
    <!-- 403 Error Page -->
    <div id="error-403" class="error-container error-403 hidden">
        <div class="error-bg">
            <div
                class="floating-food"
                style="top: 15%; left: 12%; font-size: 3rem">
                🔒
            </div>
            <div
                class="floating-food"
                style="top: 25%; right: 18%; font-size: 2.5rem">
                🛡️
            </div>
            <div
                class="floating-food"
                style="bottom: 25%; left: 15%; font-size: 2rem">
                ⛔
            </div>
            <div
                class="floating-food"
                style="bottom: 15%; right: 20%; font-size: 3.5rem">
                🚫
            </div>
            <div
                class="floating-food"
                style="top: 45%; left: 8%; font-size: 2.2rem">
                🔐
            </div>
            <div
                class="floating-food"
                style="top: 65%; right: 12%; font-size: 2.8rem">
                🚪
            </div>
        </div>
        ...
        <div class="error-card">
            ...
            <h1 class="error-title">Akses <span>Terlarang</span></h1>
            <p class="error-description">
                Maaf, Anda tidak memiliki izin untuk mengakses halaman ini.
                Area ini khusus untuk chef dan staff dapur kami saja.
            </p>
            <a
                href="{{ route('home') }}"
                class="btn-home">
