...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | Cheche Catering</title>
...
<body>
    ...
    <!-- 404 Error Page -->
    <div id="error-404" class="error-container error-404">
        <div class="error-bg">
            <div
                class="floating-food"
                style="top: 10%; left: 10%; font-size: 3rem">
                🍕
            </div>
            <div
                class="floating-food"
                style="top: 20%; right: 15%; font-size: 2.5rem">
                🍔
            </div>
            <div
                class="floating-food"
                style="bottom: 30%; left: 20%; font-size: 2rem">
                🍰
            </div>
            <div
                class="floating-food"
                style="bottom: 20%; right: 25%; font-size: 3.5rem">
                🍝
            </div>
            <div
                class="floating-food"
                style="top: 50%; left: 5%; font-size: 2.2rem">
                🥗
            </div>
            <div
                class="floating-food"
                style="top: 70%; right: 10%; font-size: 2.8rem">
                🍜
            </div>
        </div>
        ...
        <div class="error-card">
            ...
            <p class="error-description">
                Oops! Sepertinya menu yang Anda cari tidak ada di dapur
                kami. Halaman ini mungkin sudah dipindah atau tidak pernah
                ada.
            </p>
            <a
                href="{{ route('home') }}"
